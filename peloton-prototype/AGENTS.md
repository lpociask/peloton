...
- Keep “Redaktorzy” as a persistent text tab directly beside the segmented PL/EN switch in the cover masthead. Do not add a hamburger or slide-out menu until it has real, non-duplicated destinations; keep language switching available in the cover, contents, editorial, and article toolbars.
